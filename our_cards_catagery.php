...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">Our Cards Catagery</div>
        </div>
        <div class="owl-carousel owl-theme" id="slider2">
            
            <?php 
			$querys=mysql_querry("select * from catagerylayout");
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><?php echo $res['layout_catageryimage'];?> <img src="images/seth-doyle-133175.jpg" alt=""/></div>
                    <div>
                        <a href="our_cards_catagery.php" class="d-block fh5co_small_post_heading"><span class="">The top 10 best computer speakers in the market</span></a>
        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img src="images/nick-karvounis-78711.jpg" alt="img"/>
                ...
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                    ...
                    <div class=""><a href="cardgenerate.php" class="fh5co_good_font"> After all is said and done, more is said than done </a></div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
                    ...
                    <div class="fh5co_suceefh5co_height_2"><img src="images/science-578x362.jpg" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="cardgenerate.php" class="fh5co_good_font_2"> After all is said and done, <br>more is said than done </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="images/joe-gardner-75333.jpg" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            ...
                            <div class=""><a href="cardgenerate.php" class="fh5co_good_font_2"> After all is said and done... </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="images/ryan-moreno-98837.jpg" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="cardgenerate.php" class="fh5co_good_font_2"> After all is said and done, more is said than done </a></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="images/10-1-1-875x500.jpg" alt="img"/>
                        ...
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;Oct
                                28,2017 </a></div>
                            <div class=""><a href="cardgenerate.php" class="fh5co_good_font_2"> After all is said and done, more is said... </a></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    ...
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="cardgenerate.php" class="text-white"> Here's a new way to take better photos for instagram </a>
        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="our_cards_catagery.php" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        nostrud quis xercitation ullamco. </a> <a href="our_cards_catagery.php" class="fh5co_mini_time py-3"> Thomson Smith -
                        April 18,2016 </a>
                        <div class="fh5co_consectetur"> Amet consectetur adipisicing elit, sed do eiusmod tempor incididunt
                            ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation.
                        </div>
                ...
                <div class="row pb-4">
                    ...
                    <div class="col-md-7">
                        <a href="cardgenerate.php" class="fh5co_magna py-2"> Magna aliqua ut enim ad minim veniam quis
                        nostrud quis xercitation ullamco. </a> <a href="#" class="fh5co_mini_time py-3"> Thomson Smith -
                        April 18,2016 </a>
                        <div class="fh5co_consectetur"> Quis nostrud xercitation ullamco laboris nisi aliquip ex ea commodo
                            consequat.
